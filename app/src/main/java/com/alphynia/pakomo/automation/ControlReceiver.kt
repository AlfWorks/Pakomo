 ...
 * [VpnServiceController][com.alphynia.pakomo.vpn.VpnServiceController] — no engine or policy logic lives here.
 *
...
class ControlReceiver : BroadcastReceiver() {
    ...
    private fun request(context: Context, prefs: PakomoPreferences, ruleOverride: com.alphynia.pakomo.core.model.NetworkRule): ControlRequest {
